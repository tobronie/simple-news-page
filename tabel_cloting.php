            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Cloting</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Jl. Gajayana no 50, Lowokwaru, Malang</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                            <a href="tambah_cloting.php" class="btn btn-primary">Tambah Data</a>
                            </div>
                        </div>
                        <div class="card mb-4">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><?php echo $d['artikel']; ?></th>
                                                <th><img src="<?php echo $gambarSrc; ?>" style="width:100px;"></th>
                                                <th>
                                                    <a href="edit_cloting.php?id=<?= $d['id']; ?>" class="btn btn-success">Edit</a>
                                                    <a href="proses_delete_cloting.php?id=<?= $d['id']; ?>" class="btn btn-danger">Delete</a>
                                                </th>
                                            </tr>
                                        <?php
                                            }
