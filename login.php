                                    ...
                                    <div class="card-body">
                                        <form class="user" action="proses_login.php" method="POST">
                                            <div class="form-floating mb-3">
                                                <input required  name="email" class="form-control" id="inputEmail" type="email" placeholder="name@example.com">
                                        ...
                                        <div class="card-footer d-flex align-items-center justify-content-end mt-4 mb-0">
                                            <a class="btn btn-success ml-auto mr-2" href="register.php">Register</a>
                                        </div>
                                    </div> 
                                </div>
                            </div>
